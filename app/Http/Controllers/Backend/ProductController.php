...
class ProductController extends Controller
{
    ...
    public function EditProduct($id){
        ...
        return view('backend.product.product_edit',compact('brands','categories','activeVendor','subcategory','products','multiImages'));
    ...
    public function StoreProductUpdate(Request $request){
        ...
        $notification = array(
            'message' => 'Without Image Product Update  Successfully',
            'alert-type' => 'success'
        );
    ...
    public function StockProduct(){
        $products= Product::latest()->get();
        return view('backend.product.stock_product', compact('products'));
    }// end method

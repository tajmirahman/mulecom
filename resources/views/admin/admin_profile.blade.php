                            ...
                            <form action="{{ route('admin.profile.store') }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <img id="showImage" src="{{ !empty($adminData->photo) ? url('upload/admin_image/'.$adminData->photo): url('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary " style="width:100px">

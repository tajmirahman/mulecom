                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('site.setting.store') }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="tel" name="company_address" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                         <img id="showImage" src="{{ asset($siteSetting->logo) }}" alt="" style="width:100px; height: 100px;"  >
                                    </div>
                                </div>

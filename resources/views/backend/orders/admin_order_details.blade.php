                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table" style="background:#F4F6FA;font-weight: 600;">
                            ...
                            <tr>
                                <th>Order Status:</th>
                                <th><span class="badge bg-danger" style="font-size: 15px;">{{ $order->status
                                        }}</span></th>
                            </tr>
                            <tr>
                                <th></th>
                                ...
                                <th><a href="{{ route('confirm-procecing' ,$order->id) }}" class="btn btn-block btn-success" id="procecing">Procecing Order</a></th>

                                @elseif($order->status == 'processing')
                                <th><a href="{{ route('procecing-delivered' ,$order->id) }}" class="btn btn-block btn-success" id="delivered">Delivered Order</a></th>
                                @endif

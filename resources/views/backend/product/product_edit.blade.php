...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form method="post" action="{{ route('store.product.update') }}">
                @csrf
                            ...
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="short_descp" class="form-control" id="inputProductDescription"
                                        rows="3">{{ $products->short_dscp }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="inputProductDescription" class="form-label">Long Description</label>
                                    <textarea id="mytextarea" name="long_descp">{!! $products->long_dscp !!}</textarea>
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="brand_id" class="form-select" id="inputProductType">
                                            ...
                                            <option value="{{ $brand->id }}" {{ $brand->id == $products->brand_id ?
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="category_id" class="form-select" id="inputVendor">
                                            ...
                                            <option value="{{ $cat->id }}" {{ $cat->id == $products->category_id ?
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="vendor_id" class="form-select" id="inputCollection">
                                            ...
                                            <option value="{{ $vendor->id }}" {{ $vendor->id == $products->vendor_id ?
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="hot_deals" type="checkbox"
                                                        value="1" id="flexCheckDefault" {{ $products->hot_deals == 1 ?
                                                    'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="featured" type="checkbox"
                                                        value="1" id="flexCheckDefault" {{ $products->featured == 1 ?
                                                    'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="special_offer" type="checkbox"
                                                        value="1" id="flexCheckDefault" {{ $products->special_offer == 1
                                                    ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="special_deals" type="checkbox"
                                                        value="1" id="flexCheckDefault" {{ $products->special_deals == 1
                                                    ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="flexCheckDefault">Special
                                                        Deals</label>
                                                </div>
...
{{-- //thumbnail section start here --}}

<div class="page-content">

    <h6 class="mb-0 text-uppercase">Main Image Thumbnail</h6>
    <hr>
    <div class="card">
        <form method="post" action="{{ route('update.product.thumbnail') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <input type="submit" class="btn btn-primary px-4" value="Update Thimbnail" />
...
{{-- //Thumbnail section ends here --}}


{{-- //multiImage section start here --}}
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    <form method="post" action="{{ route('update.product.multiimage') }}" enctype="multipart/form-data">
                        ...
                        @foreach($multiImages as $key => $mul_img)
                        <tr>
                            <th scope="row">{{ $key+1 }}</th>
                            <td>
                                <img src="{{ asset($mul_img->photo_name) }}" style="width:100px; height:100px">
                            </td>
                            <td>
                                <input class="form-group" type="file"
                                    name="multi_img[{{ $mul_img->id }}]">
                            ...
                            <td>
                                ...
                                <a href="{{ route('product.multiimage.delete',$mul_img->id) }}" class="btn btn-danger" id="delete">delete</a>
                            </td>
                        </tr>

                    ...
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{ asset('frontend/assets') }}/imgs/theme/icons/icon-contact.svg"
                                    alt="" /><strong>Call Us:</strong><span>{{ $Setting->phone_one }}</span></li>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">&copy; 2023, <strong class="text-brand">Nest</strong> -{{ $Setting->copyright }} <br />All rights reserved</p>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                <div class="mobile-social-icon">
                    <h6>Follow Us</h6>
                    <a href="{{ $Setting->facebook }}"><img src="{{ asset('frontend/assets') }}/imgs/theme/icons/icon-facebook-white.svg"
                            alt="" /></a>
                    <a href="{{ $Setting->twitter }}"><img src="{{ asset('frontend/assets') }}/imgs/theme/icons/icon-twitter-white.svg"
                            alt="" /></a>

                    <a href="{{ $Setting->youtube }}"><img src="{{ asset('frontend/assets') }}/imgs/theme/icons/icon-youtube-white.svg"
                            alt="" /></a>
                </div>

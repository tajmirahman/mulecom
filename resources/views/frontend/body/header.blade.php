                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <span class="lable ml-2 " style="margin-right: 4px">|</span>
                            ...
                            <ul>
                                ...
                                @endphp
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="{{ url('/product/subcategory/'.$sub_cat->id.'/'.$sub_cat->subcategory_slug) }}">{{ $sub_cat->subcategory_name }}</a>
                                        </li>
                                        @endforeach
                                ...
                                <li>
                                    <a href="{{ route('home.blog') }}">Blog Post</a>
                                </li>
                            </ul>
                        </nav>
                    </div>

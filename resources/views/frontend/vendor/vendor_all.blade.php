    ...
    <div class="container">
        ...
        <div class="row vendor-grid">
            ...
            <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                <div class="vendor-wrap mb-40" style="width:300px;height: 400px;">
                    ...
                    <div class="vendor-content-wrap">
                        <div class="d-flex justify-content-between align-items-end mb-30">
                            <div>
                                ...
                                <h4 class="mb-5"><a href="{{ route('vendor.details',$vendor->id) }}">{{ $vendor->name
                                        }}</a></h4>
                        ...
                        <div class="vendor-info mb-30">
                            <ul class="contact-infor text-muted">
                                <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address:
                                    </strong> <span>{{ $vendor->address }}</span></li>

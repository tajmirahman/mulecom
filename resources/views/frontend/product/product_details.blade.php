    ...
    <div class="container mb-30">
        <div class="row">
                ...
                <div class="product-price primary-color float-left">
                    ...
                    <span>
                        <div class="product-price primary-color float-left">
                            ...
                            <span>
                                <span class="save-price font-md color3 ml-15">{{ round($total_discount) }}%
                                    Off</span>
            ...
            <div class="short-desc mb-20">
                <p class="font-lg">{{ $product->short_dscp }}</p>
            </div>
            ...
            <div class="detail-extralink mb-50">
                <div class="detail-qty border radius">
                    ...
                    <input type="text" name="qty" id="dqty" class="qty-val" value="1" min="1">
                ...
                <div class="product-extra-link2">
                    ...
                    <button type="submit" class="button button-add-to-cart" onclick="addToCartDetails()"><i
                            class="fi-rs-shopping-cart"></i>Add to
                        cart</button>
            ...
            <div class="font-xs">
                <ul class="mr-50 float-start">
                    ...
                    <li>SubCategory: <span class="text-brand">{{ $product->subcategory->subcategory_name }}</span>
                    </li>
                </ul>
        ...
        <div class="tab-content shop_info_tab entry-main-content">
            ...
            <div class="tab-pane fade" id="Vendor-info">
                <div class="vendor-logo d-flex mb-30">
                    <img src="{{ !empty($product->vendor->photo) ? url('upload/vendor_image/' . $product->vendor->photo) : url('upload/no_image.jpg') }}"
                        alt="" />
            ...
            <div class="tab-pane fade" id="Reviews">
                                ...
                                <div class="single-comment justify-content-between d-flex mb-30">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb text-center">
                                            <img src="{{ !empty($item->user->photo) ? url('upload/user_image/' . $item->user->photo) : url('upload/no_image.jpg') }}"
                                                alt="" />
                ...
                <div class="comment-form">
                    ...
                    @guest
                    <p> <b>For Add Product Review. You Need To Login First <a href="{{ route('login') }}">Login Here
                            </a> </b></p>
                    @else
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form class="form-contact comment_form" action="{{ route('store.review') }}" method="POST"
                                id="commentForm">
                                @csrf
